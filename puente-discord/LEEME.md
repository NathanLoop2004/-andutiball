# Puente de Discord de ÑandutíHax
...
6. En el `.env` de ÑandutíHax: `DISCORD_REDIRECT_URI=https://<tu-usuario>.github.io/nanduti-discord/`

Si algún día ÑandutíHax tiene dominio propio, agregalo en `DOMINIOS_PERMITIDOS` del `index.html`.
