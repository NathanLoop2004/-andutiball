...
//            1/(1-damping):
//                0.9888 → 89   ← la de ahora
//                0.990  → 100  (la del autor)
//                0.991  → 111
//                0.993  → 143  (se probó y quedaba demasiado viva)
//            Bajó dos veces a pedido del usuario ("bajá un 20%" cada vez) y terminó un poco
//            por debajo de la del autor. Arriba de 0.995 se vuelve un jabón.
...
const FISICA_PELOTA = { damping: 0.9888, bCoef: 0.5 };
