...
const CATALOGO = [
  ...
  // ── Moderación ──
  // De fábrica está en 99, o sea sin límite en la práctica: echaba a gente que juega desde la
  // misma casa o desde un ciber. El tope llega hasta 99 para poder volver a ponerle un límite
  // desde el panel si alguna vez hace falta.
  P("moderacion", "MaximoJugadoresPorIp", "Máximo de jugadores por IP", "entero", { min: 1, max: 99 }),
